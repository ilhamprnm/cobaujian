      ...
      <div>
        <div className='fixed max-w-[400px] w-full mx-auto bg-white p-5 rounded-md z-[10001] top-[20%] left-1/2 transform -translate-x-1/2'>
          <div className='flex justify-between items-center'>
            ...
            <button className='p-1 px-2 rounded-md hover:bg-gray-200 font-semibold' onClick={() => {setModalData({...modalData,modal:!modalData.modal})}}>X</button>
          </div>
          ...
          <div className='mt-5 flex flex-col items-center text-center gap-4'>
              ...
              <div className='w-full'>
                <button className='w-full bg-[#35b486] hover:bg-[#268562] rounded-full p-2 font-bold text-white'>+ Keranjang</button>
              </div>
